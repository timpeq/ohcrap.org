...
// Temporary hack of https://deno.land/std/http/file_server.ts for use until std/http serveFile works on Deno Deploy
...
export async function serveFile(_request:Request, filePath: string): Promise<Response> {
